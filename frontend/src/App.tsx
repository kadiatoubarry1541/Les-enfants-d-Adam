...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <label className="text-sm text-gray-600 dark:text-gray-300">Lang</label>
              <select
                className="px-2 py-1 border rounded-md text-sm bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-gray-100"
                value={lang}
                onChange={(e) =>
      ...
      {/* Footer avec Tailwind */}
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-900 dark:to-black text-white py-6 mt-auto">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-300 dark:text-gray-400">
            2025 Les Enfants d'Adam et Eve - Système d'enregistrement
            généalogique
          </p>
        </div>
      </footer>
