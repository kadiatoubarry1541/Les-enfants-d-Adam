            ...
            <div className="row">
              <div className="col-6">
                <Field label={t('label.family_father')}>
                  <Select value={state.famillePere} onChange={(v)=>set({ famillePere: v })} options={FAMILLES} placeholder={t('option.select_placeholder')} />
                </Field>
              </div>
              <div className="col-6">
              ...
              <div className="col-6">
                <Field label={t('label.father_status')}>
                  <Select value={state.pereStatut} onChange={(v)=>set({ pereStatut: v as any })} options={[ { value: 'Vivant', label: t('option.status_alive') }, { value: 'Mort', label: t('option.status_dead') } ]} placeholder={t('option.select_placeholder')} />
                </Field>
              </div>
              <div className="col-6">
              ...
              <div className="col-6">
                <Field label={t('label.mother_status')}>
                  <Select value={state.mereStatut} onChange={(v)=>set({ mereStatut: v as any })} options={[ { value: 'Vivant', label: t('option.status_alive') }, { value: 'Mort', label: t('option.status_dead') } ]} placeholder={t('option.select_placeholder')} />
                </Field>
              </div>
              <div className="col-6">
            ...
            <div className="row">
              ...
              <div className="col-4">
                <Field label={t('label.gender')}>
                  <Select value={state.genre} onChange={(v)=>set({ genre: v as any })} options={[ { value: 'FEMME', label: t('option.gender_female') }, { value: 'HOMME', label: t('option.gender_male') } ]} placeholder={t('option.select_placeholder')} />
                </Field>
              </div>
            </div>
            <div className="row">
        ...
        <div className="stack">
          ...
          <div className="card stack">
            <div className="row">
              ...
              <div className="col-4"><Field label={t('label.health')}><Select value={state.situationSanitaire} onChange={(v)=>set({ situationSanitaire: v as any })} options={[ { value: 'En bonne santé', label: t('option.health_healthy') }, { value: 'Malade', label: t('option.health_sick') } ]} placeholder={t('option.select_placeholder')} /></Field></div>
            </div>
            <div className="row">
            ...
            <div className="row">
              <div className="col-4"><Field label={t('label.economic')}><Select value={state.situationEco} onChange={(v)=>set({ situationEco: v as any })} options={[ { value: 'Droit au ZAKA', label: t('option.economic_zaka') }, { value: 'Moyen', label: t('option.economic_medium') }, { value: 'Pauvre', label: t('option.economic_poor') }, { value: 'Riche', label: t('option.economic_rich') } ]} placeholder={t('option.select_placeholder')} /></Field></div>
