  ...
  const getDefaultGroups = (): RegionGroup[] => [
    {
      id: '1',
      name: 'Labé Connect',
      description: 'Communauté des habitants de Labé pour échanger et préserver nos traditions',
    ...
    {
      id: '2',
      name: 'Mamou Solidarité',
      description: 'Organisation de Mamou pour le développement et l\'entraide communautaire',
      region: 'Fouta-Djallon',
      members: [],
      posts: [],
      isActive: true,
    ...
    },
    {
      ...
      description: 'Communauté de Pita pour partager nos traditions et cultures',
      region: 'Fouta-Djallon',
      members: [],
      posts: [],
      isActive: true,
    ...
    },
    {
      ...
      description: 'Organisation de Dalaba pour célébrer notre région montagneuse',
      region: 'Fouta-Djallon',
      members: [],
      posts: [],
      isActive: true,
      ...
      <div className="bg-white rounded-xl shadow-sm border-l-4 border-l-green-500 border border-slate-200 p-6 hover:shadow-md transition-shadow duration-200">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Rencontrez les habitants de votre région montagneuse pour échanger par écrit, vidéo et audio</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold text-green-900 mb-3">⛰️ À propos du Fouta-Djallon</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-green-800">
            <div>
              <h4 className="font-medium mb-2">Villes principales :</h4>
              <ul className="space-y-1">
                <li>• Labé (capitale régionale)</li>
                <li>• Mamou</li>
                <li>• Pita</li>
                <li>• Dalaba</li>
                <li>• Tougué</li>
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>• Région montagneuse</li>
                <li>• Climat tempéré</li>
                <li>• Agriculture et élevage</li>
                <li>• Traditions peules</li>
                <li>• Sources d'eau</li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Ex: Place centrale de Labé"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Réunion des anciens"
                />
              </div>
              <div>
